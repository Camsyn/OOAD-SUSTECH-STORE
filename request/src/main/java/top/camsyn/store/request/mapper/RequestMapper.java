...
public interface RequestMapper extends BaseMapper<Request> {
    ...
    @Select("<script>\n" +
            ...
            "                        and r.labels regexp '\"${s.queryStr}\"'\n" +
            "                    </when>\n" +
            "                    <when test='s.searchStrategy==4' >\n" +
            "                        and ( r.title = #{s.queryStr} or r.desc_ = #{s.queryStr} or r.labels regexp '\"${s.queryStr}\"')\n" +
            "                    </when>\n" +
            "                    <otherwise></otherwise>\n" +
            "                </choose>\n" +
            "            </when>\n" +
            ...
            "                    </when>\n" +
            "                    <when test='s.searchStrategy==4' >\n" +
            "                        and ( r.title regexp #{s.queryStr} or r.desc_ regexp #{s.queryStr} or r.labels regexp #{s.queryStr})\n" +
            "                    </when>\n" +
            "                    <otherwise></otherwise>\n" +
            "                </choose>\n" +
            "            </otherwise>\n" +
            ...
            "            and\n" +
            "            <foreach collection=\"s.labels\" item=\"label\" open=\"(\" close=\")\" separator=\" or \" index=\"i\">\n" +
            "                r.labels regexp '\"${label}\"'\n" +
            "            </foreach>\n" +
            "        </if>\n" +
            "        \n" +
